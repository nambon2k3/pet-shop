 ...
 * Use the {@link ProcessingTablayoutFragment#newInstance} factory method to
...
public class ProcessingTablayoutFragment extends Fragment {
    ...
    public ProcessingTablayoutFragment() {
     ...
     * @return A new instance of fragment ProcessingTablayoutFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ProcessingTablayoutFragment newInstance(String param1, String param2) {
        ProcessingTablayoutFragment fragment = new ProcessingTablayoutFragment();
...
//        recyclerView.setLayoutManager(new LinearLayoutManager(ProcessingTablayoutFragment.this, LinearLayoutManager.VERTICAL, false));
    ...
    public void onDestroyView() {
        super.onDestroyView();
        // Đảm bảo giải phóng binding khi Fragment bị hủy
        binding = null;
    }
}