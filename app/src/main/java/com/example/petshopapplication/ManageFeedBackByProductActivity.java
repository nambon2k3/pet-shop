...
import com.example.petshopapplication.databinding.ActivityListManageFeedbackBinding;
...
public class ManageFeedBackByProductActivity extends AppCompatActivity implements ListProductCategoryAdapter.OnCategoryClickListener {

    private final int LIMIT_PAGE = 3;
    private final int ITEMS_PER_PAGE = 16;
    ActivityListManageFeedbackBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityListManageFeedbackBinding.inflate(getLayoutInflater());
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if (categoryItems.size() > 1) {
                        categoryAdapter = new ListProductCategoryAdapter(categoryItems, ManageFeedBackByProductActivity.this);
                        binding.rcvListProductCategory.setLayoutManager(new LinearLayoutManager(ManageFeedBackByProductActivity.this, RecyclerView.HORIZONTAL, false));
        ...
        query.limitToFirst(ITEMS_PER_PAGE).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    binding.rcvListProduct.setLayoutManager(new GridLayoutManager(ManageFeedBackByProductActivity.this, 2));
